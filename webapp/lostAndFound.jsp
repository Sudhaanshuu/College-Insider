...
<head>
<meta charset="UTF-8">
<title>Lost | College Insider</title>
...
<div class="section-title" style="margin-top: 70px; ">
        ...
        <p>College help form</p>
    </div>
<div class="container1" style="padding-left:40px">
    <div class="image-container1">
    <img src="assets/lost.jpg" alt="Intro Image" style="height: 300px;">
</div>
    <div class="text-container">
        <h2>Lost and Found</h2>
    Beyond its practical benefits, the Lost and Found feature aligns with principles of sustainability and resourcefulness. By facilitating the retrieval of lost items, the feature minimizes unnecessary waste and consumption. Rather than replacing lost belongings, students can reclaim their possessions, reducing financial strain and environmental impact. Furthermore, the feature encourages responsible behavior, prompting students to exercise vigilance and mindfulness regarding their personal belongings.Beyond its practical benefits, the Lost and Found feature aligns with principles of sustainability and resourcefulness. By facilitating the retrieval of lost items, the feature minimizes unnecessary waste and consumption. Rather than replacing lost belongings, students can reclaim their possessions, reducing financial strain and environmental impact. Furthermore, the feature encourages responsible behavior, prompting students to exercise vigilance and mindfulness regarding their personal belongings.</p></div>
</div>
</div>
<body>
<div class="section-title">
        ...
        <p>Add New Post Or See Others</p>
    ...
    <div class="container3"style="padding:40px">
        ...
        <div class="section-title">
            ...
            <form action="AddLostFoundItemServlet" method="post">
            <label for="item_name">Your Name:</label><br>
                <input type="text" id="person_name" name="person_name"><br>
                <label for="item_name">Your e-mail:</label><br>
                <input type="text" id="person_email" name="person_email"><br>
                <label for="type">Choose activity:</label><br>
        ...
        <div class="section-title">
            <h2>Display Query</h2>
            <p>Lost and Found Posts</p>
            </div>
            
    <div id="posts">
   
    <jsp:include page="ListLostFoundItemsServlet" /> 
